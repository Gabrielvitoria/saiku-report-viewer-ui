...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReportViewer = __webpack_require__(216);
	
	var _ReportViewer2 = _interopRequireDefault(_ReportViewer);
	...
	var routes = _react2.default.createElement(
	  ...
	  _react2.default.createElement(_reactRouter.Route, { path: '/', component: _ReportViewer2.default })
	);
	
	// The primary API for rendering into the DOM.
	_reactDom2.default.render(routes, document.querySelector('#saiku-app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReportViewer = function (_React$Component) {
	  _inherits(ReportViewer, _React$Component);
	
	  function ReportViewer() {
	    _classCallCheck(this, ReportViewer);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ReportViewer).apply(this, arguments));
	  }
